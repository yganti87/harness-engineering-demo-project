...
- Include verification screenshots and videos from `docs/verification-output/{id}/` if browser verification was performed (screenshots + videos live here, not in test-output).
